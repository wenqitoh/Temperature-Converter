"""Component 2 - Converter GUI v1
creating buttons and labels for converting from F/C
Wen-Qi Toh
24/3/21"""
...
class Converter:
    def __init__(self):
        ...
        self.to_c_button = Button(self.conversion_btns_frame, text="To Centigrade",
                                  font="arial 10 bold", bg="Khaki1", padx=10, pady=10)
        self.to_c_button.grid(row=0, column=0)

        self.to_f_button = Button(self.conversion_btns_frame, text="To Fahrenheit",
                                  font="arial 10 bold", bg="Orchid1", padx=10, pady=10)
