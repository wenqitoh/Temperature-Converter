"""Component 9 - History GUI v1b
this is a copy of 09_History_GUI_v1
(to match 10_assembled_converter)
Changed the name of the calc_history button to history_button (78, 84)
added lambda command at lines 82-83
disabled history button (86-87) if nothing in the all_calc_list
Wen-Qi Toh
12/4/22"""
