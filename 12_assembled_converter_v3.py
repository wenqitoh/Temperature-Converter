"""Component 12 - v3, completed program
Wen-Qi Toh
18/04/22"""
...
class Converter:
    def __init__(self):
        ...
        self.to_c_button = Button(self.conversion_btns_frame,
                                  text="To Centigrade", font="arial 10 bold",
                                  command=lambda: self.temp_convert(-459),
                                  bg="Khaki1", padx=10, pady=10)
        self.to_c_button.grid(row=0, column=0)

        self.to_f_button = Button(self.conversion_btns_frame,
    ...
    def help(self):
        ...
        get_help.help_text.configure(text="Please enter a number in the box "
                                          ...
                                          " up to seven recent calculations "
...
class History:
    def __init__(self, partner, calc_history):
        ...
        # if users press 'x' at top, closes history & 'releases' history button
...
class Export:
    def __init__(self, partner, calc_history):
        ...
        self.export_text = Label(self.export_frame,
                                 ...
                                 bg="#ffafaf", fg="maroon", wrap=250)   # pink
    ...
    def save_history(self, partner, calc_history):
        # regular expression to check file name can be Upper of
        # lower case letters
        ...
        if has_error == "yes":  # decribe problem
